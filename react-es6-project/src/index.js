...
// so you make the List that contains the stuff which has properties assigned and map them
const books = [
  {
    id: 1,
    img:
...
// delete the functions and do them again// by yourelf.
